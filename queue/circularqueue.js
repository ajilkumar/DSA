...
var MyCircularQueue = function(k) {
    this.capacity = k;             // maximum size of the queue
    this.queue = new Array(k);     // fixed size array
...
MyCircularQueue.prototype.enQueue = function(value) {
    ...
    this.rear = (this.rear + 1) % this.capacity; // move rear circularly
    this.count++;
...
MyCircularQueue.prototype.Rear = function() {
    ...
    // rear points to next free spot, so go one step back
